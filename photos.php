...
$order_by = $_GET['order_by'] ?? 'DateTimeOriginal';
$order_dir = $_GET['order_dir'] ?? 'ASC';
// データベースから写真一覧を取得

$sql = "SELECT id, image_url, file_name, image_content, image_title FROM j10images WHERE u_id = :u_id ORDER BY $order_by $order_dir";
$stmt = $pdo->prepare($sql);
...
<div class="main-content">
    <aside>
        <div class="sort-container">
            <div class="sort-header">並べ替え</div>
            <div class="sort-content">
                <ul class="sort-list">
                    <li><a href="?order_by=DateTimeOriginal&order_dir=ASC">撮影日時 昇順</a></li>
                    <li><a href="?order_by=DateTimeOriginal&order_dir=DESC">撮影日時 降順</a></li>
                    <li><a href="?order_by=created_at&order_dir=ASC">投稿日時 昇順</a></li>
                    <li><a href="?order_by=created_at&order_dir=DESC">投稿日時 降順</a></li>
                    <li><a href="?order_by=IFD_Make&order_dir=ASC">メーカー名 昇順</a></li>
                    <li><a href="?order_by=IFD_Make&order_dir=DESC">メーカー名 降順</a></li>
                </ul>
            </div>
        </div>
    </aside>
